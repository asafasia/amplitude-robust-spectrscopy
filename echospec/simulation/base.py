...
class BaseExperiment(ABC, Generic[ResultsT]):
    ...
    def save(self, base_path: Optional[Path] = None, save_figure: bool = True) -> Path:
        """
        Save experiment data, parameters, options, and optionally the figure.
        ...
        base_path : Optional[Path]
            Base directory for saving. If None, uses './data'
        save_figure : bool
            Whether to save the current matplotlib figure
