...
\begin{figure}[t]
    ...
    exhibits smaller center variations. The constant-drive curve uses
    the q6 anharmonicity in the three-level simulation.
...
With the q6 anharmonicity $\alpha/(2\pi)=-237~\mathrm{MHz}$, it reaches
...
variations with the three-level constant-drive simulation for q6. The
experimental curves retain the centering used in
Fig.~\ref{fig:ac-stark-correction-maps}. The simulated megahertz-scale
displacement contrasts with the kilohertz-scale
