...
parameters.
Independent measurements on qubit \CoherenceQubit{} give
$T_1=\MeasuredTOne~\mu\mathrm{s}$ and a Ramsey time
$T_2^*=\MeasuredTTwoStar~\mu\mathrm{s}$.  A later calibration session gives
a Hahn-echo time $T_2=\MeasuredTTwoEcho~\mu\mathrm{s}$ (Supplemental
coherence-characterization section).  Because the echo trace was acquired
later, for a conservative transverse reference tied to the June 28 data we set
...
measurement-linked coherence parameters.
