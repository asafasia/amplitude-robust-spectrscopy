...
nearly constant-envelope echo, an ordinary root-Lorentzian pulse, and an
echo-root-Lorentzian pulse on q1.  All protocols use $L=20~\mu\mathrm{s}$ and
a common 200-point calibrated peak-Rabi grid extending to approximately
$25.1~\mathrm{MHz}$.  The constant-envelope echo uses $c=0.99$, while the two
root-Lorentzian protocols use $c=0.005$.  The upper and lower rows span broad
$100~\mathrm{MHz}$ and narrow $1~\mathrm{MHz}$ detuning domains,
respectively.  The broad maps and narrow constant-envelope map use 200 shots
per point.  The narrow echo-root-Lorentzian map uses 1000; the narrow ordinary
root-Lorentzian run requested 1000 shots but contains 216 completed averages
per point.  The constant-envelope and ordinary root-Lorentzian measurements
...
use $L=20~\mu\mathrm{s}$ and $c=0.002$.  The three rows compare the protocols at
$\Omega_0/(2\pi)=2.5$, $10$, and $40~\mathrm{MHz}$, making the echo-induced
