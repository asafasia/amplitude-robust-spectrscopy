...
constant pulse, an ordinary root-Lorentzian pulse, and an
echo-root-Lorentzian pulse on q1.  All protocols use $L=20~\mu\mathrm{s}$ and
a calibrated peak-Rabi range extending to approximately $42.5~\mathrm{MHz}$.
...
$\Omega_0/(2\pi)=3$, $20$, and $40~\mathrm{MHz}$, making the echo-induced
