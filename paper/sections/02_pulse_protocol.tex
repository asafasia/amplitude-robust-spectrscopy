...
\begin{figure*}[t]
    ...
    \caption{
Experimental q1 spectroscopy maps for $20~\mu\mathrm{s}$ pulses.
From left to right: constant, root-Lorentzian, and echo-root-Lorentzian
pulses, with $c=0.005$ for both shaped pulses. The Lorentzian pulses produce
extremely narrow resonance features compared with the power-broadened
constant-pulse response. The ordinary root-Lorentzian response retains
pronounced coherent oscillations as the drive amplitude increases.
The echo suppresses these oscillations, revealing a narrow, persistent
resonance-centered depletion feature across the measured drive range.
    }
