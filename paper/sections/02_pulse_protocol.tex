...
$+50~\mathrm{MHz}$); the lower row shows the narrow $1~\mathrm{MHz}$ domain
...
from zero to approximately $25.1~\mathrm{MHz}$.  Active reset and
state-discriminated readout are used throughout.
    }
