...
Figures~\ref{fig:simulated-duration-cutoff-10us}--
\ref{fig:simulated-duration-cutoff-30us} compare two-dimensional simulated
spectroscopy maps for matched echo-root-Lorentzian and root-Lorentzian pulses.
Each figure fixes the total duration at $L=10$, 20, or $30~\mu\mathrm{s}$;
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.98\textwidth]{../figures/paper/09_simulated_echo_lorentzian_10us.pdf}
    \caption{Simulated cutoff comparison for $L=10~\mu\mathrm{s}$.  The upper
    ...
    \label{fig:simulated-duration-cutoff-10us}
\end{figure}
\clearpage
...
\begin{figure}[t]
    ...
    Fig.~\ref{fig:simulated-duration-cutoff-10us}.}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.98\textwidth]{../figures/paper/09_simulated_echo_lorentzian_30us.pdf}
    \caption{Simulated cutoff comparison for $L=30~\mu\mathrm{s}$, using the
    same layout, axes, color scale, and model parameters as
    Fig.~\ref{fig:simulated-duration-cutoff-10us}.}
    \label{fig:simulated-duration-cutoff-30us}
\end{figure}
\clearpage
