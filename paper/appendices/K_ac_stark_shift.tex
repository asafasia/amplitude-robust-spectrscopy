...
\begin{table}[b]
    ...
    \begin{tabular}{ccccc}
        ...
        \colrule
        20 & 0.980 & 0.003 & 0.004 & 0.003 \\
        40 & 3.685 & -0.001 & -0.005 & 0.013 \\
        60 & 7.605 & 0.001 & -0.010 & 0.028
    \end{tabular}
    \end{ruledtabular}
\end{table}
...
quadrature follows the DRAG construction for weakly anharmonic
qubits~\cite{motzoi_drag_2009,gambetta_analytic_2011}:
\begin{equation}
    \Omega_Q(t)
...
detuning convention; such drive-dependent detuning corrections arise in the
same adiabatic-control framework~\cite{gambetta_analytic_2011}.
