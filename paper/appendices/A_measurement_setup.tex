...
$T_2^*=\MeasuredTTwoStar~\mu\mathrm{s}$.  A Hahn-echo measurement acquired in
a later calibration session gives $T_2=\MeasuredTTwoEcho~\mu\mathrm{s}$ from
an exponential fit with a constant offset.  The quoted uncertainties are
one-standard-deviation estimates from the fit covariance matrices.  Because
the Hahn-echo trace was acquired later, comparisons tied to the June 28 data
retain the conservative value
$T_{2,\mathrm{eff}}=T_2^*=\EffectiveTTwo~\mu\mathrm{s}$.
...
\begin{figure}[t]
    ...
    sinusoidal fit. (c) Hahn-echo decay acquired in a later calibration session,
